...
then
    ...
    COVERAGE="-javaagent:$AGENT=destfile=build/jacoco/h2o-gapstat.exec"
...
# On this h2o-gapstat testMultiNode.sh only, force the tests.txt to be in the same order for all machines.
